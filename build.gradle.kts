...
kotlin {
    ...
    val xcf = XCFramework("Zeroize")

    macosArm64 {
        binaries.framework { baseName = "Zeroize"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Zeroize"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Zeroize"
        flattenPackage = "io.github.kotlinmania.zeroize"
    }

    android {
        namespace = "io.github.kotlinmania.zeroize"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "zeroize-kotlin", version.toString())

    pom {
        name.set("zeroize-kotlin")
        description.set("Kotlin Multiplatform port of RustCrypto/utils - Securely clear secrets from memory with a simple trait built on stable Rust primitives which guarantee memory is zeroed using an operation will not be 'optimized away' by the compiler. Uses a portable pure Rust implementation that works everywhere, even WASM!")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/zeroize-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/zeroize-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/zeroize-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/zeroize-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleZeroizeXCFramework",
    "assembleZeroizeDebugXCFramework",
    "assembleZeroizeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForZeroizeXCFramework",
    "assembleReleaseIosFatFrameworkForZeroizeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForZeroizeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForZeroizeXCFramework",
    "assembleDebugMacosFatFrameworkForZeroizeXCFramework",
    "assembleReleaseMacosFatFrameworkForZeroizeXCFramework",
    "assembleDebugTvosFatFrameworkForZeroizeXCFramework",
    "assembleReleaseTvosFatFrameworkForZeroizeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForZeroizeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForZeroizeXCFramework",
    "assembleDebugWatchosFatFrameworkForZeroizeXCFramework",
    "assembleReleaseWatchosFatFrameworkForZeroizeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForZeroizeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForZeroizeXCFramework",
