...
This file is the quick-reference operating contract for zeroize-kotlin. The longer
...
zeroize-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`zeroize`](https://crates.io/crates/zeroize). Upstream Rust is the behavioral oracle while the
